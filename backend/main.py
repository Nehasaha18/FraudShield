...
try:
    ...
    print(f"Running without Redis: {e}")
...
# Security Middleware - Updated for deployment
app.add_middleware(
...
@app.get("/")
async def root():
    return {"message": "FraudShield Secure API is running", "version": "2.0.0", "status": "healthy"}
...
if __name__ == "__main__":
    ...
    # Remove SSL for deployment simplicity
    uvicorn.run(
        app,
        host="0.0.0.0",
        port=port
